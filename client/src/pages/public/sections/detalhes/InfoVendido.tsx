...
export default function InfoVendido({ veiculo }: Props) {
  return (
    <div className="flex-1">
      ...
      <p className="text-[#888] text-sm mb-4">Este veículo já foi vendido. Confira nosso estoque para encontrar outros disponíveis.</p>
      <Link to="/estoque" className="block w-full text-center px-6 py-3 text-white font-bold uppercase text-sm rounded-[8px] transition-opacity hover:opacity-80" style={{ backgroundColor: 'var(--cor-primaria)' }}>
        Ver Estoque
      </Link>
    </div>
  );
